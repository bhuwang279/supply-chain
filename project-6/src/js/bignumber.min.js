...
!(function (e) {
  ...
  function z(e, r) {
    ...
    for (f = (u = i.length) < (c = o.length) ? u : c, s = 0; s < f; s++)
      if (i[s] != o[s]) return (i[s] > o[s]) ^ n ? 1 : -1;
    return u == c ? 0 : (c < u) ^ n ? 1 : -1;
  }
  function H(e, r, n, t) {
    if (e < r || n < e || e !== (e < 0 ? B(e) : T(e)))
      throw Error(
        U +
          (t || "Argument") +
          ("number" == typeof e
  ...
  ((r = (function e(r) {
    ...
    function _(e, r) {
      var n,
        ...
        c,
        l = this;
      if (!(l instanceof _)) return new _(e, r);
      if (null == r) {
        if (e instanceof _)
          return (
            (l.s = e.s), (l.e = e.e), void (l.c = (e = e.c) ? e.slice() : e)
          );
        if ((f = "number" == typeof e) && 0 * e == 0) {
          if (((l.s = 1 / e < 0 ? ((e = -e), -1) : 1), e === ~~e)) {
            for (o = 0, s = e; 10 <= s; s /= 10, o++);
            return (l.e = o), void (l.c = [e]);
          }
          c = String(e);
        } else {
          if (((c = String(e)), !L.test(c))) return h(l, c, f);
          l.s = 45 == c.charCodeAt(0) ? ((c = c.slice(1)), -1) : 1;
        }
        -1 < (o = c.indexOf(".")) && (c = c.replace(".", "")),
          0 < (s = c.search(/e/i))
            ? (o < 0 && (o = s),
              (o += +c.slice(s + 1)),
              (c = c.substring(0, s)))
        ...
        if ((H(r, 2, S.length, "Base"), (c = String(e)), 10 == r))
          return x((l = new _(e instanceof _ ? e : c)), y + l.e + 1, N);
        if ((f = "number" == typeof e)) {
          if (0 * e != 0) return h(l, c, f, r);
          if (
            ((l.s = 1 / e < 0 ? ((c = c.slice(1)), -1) : 1),
            _.DEBUG && 15 < c.replace(/^0\.0*|\./, "").length)
          )
            throw Error(I + e);
          f = !1;
        } else l.s = 45 === c.charCodeAt(0) ? ((c = c.slice(1)), -1) : 1;
        for (n = S.slice(0, r), o = s = 0, u = c.length; s < u; s++)
          if (n.indexOf((t = c.charAt(s))) < 0) {
            if ("." == t) {
              if (o < s) {
                o = u;
                continue;
            ...
            return h(l, String(e), f, r);
          }
        -1 < (o = (c = a(c, r, 10, l.s)).indexOf("."))
          ? (c = c.replace(".", ""))
          : (o = c.length);
      }
      ...
      if ((c = c.slice(s, ++u))) {
        if (((u -= s), f && _.DEBUG && 15 < u && (G < e || e !== T(e))))
          throw Error(I + l.s * e);
        if (O < (o = o - s - 1)) l.c = l.e = null;
        else if (o < d) l.c = [(l.e = 0)];
        else {
          if (
            ((l.e = o), (l.c = []), (s = (o + 1) % M), o < 0 && (s += M), s < u)
          ) {
            for (s && l.c.push(+c.slice(0, s)), u -= M; s < u; )
              l.c.push(+c.slice(s, (s += M)));
            (c = c.slice(s)), (s = M - c.length);
          } else s -= u;
          for (; s--; c += "0");
          l.c.push(+c);
        }
    ...
    function x(e, r, n, t) {
      ...
      if (a) {
        e: {
          ...
          if ((o = r - i) < 0)
            (o += M), (s = r), (l = ((u = a[(c = 0)]) / h[i - s - 1]) % 10 | 0);
          else if ((c = B((o + 1) / M)) >= a.length) {
            if (!t) break e;
            for (; a.length <= c; a.push(0));
            (u = l = 0), (s = (o %= M) - M + (i = 1));
          } else {
            for (u = f = a[c], i = 1; 10 <= f; f /= 10, i++);
            l = (s = (o %= M) - M + i) < 0 ? 0 : (u / h[i - s - 1]) % 10 | 0;
          }
          if (
            ((t =
              t || r < 0 || null != a[c + 1] || (s < 0 ? u : u % h[i - s - 1])),
            (t =
              n < 4
                ? (l || t) && (0 == n || n == (e.s < 0 ? 3 : 2))
                : 5 < l ||
          ...
          if (
            ...
            for (;;) {
              ...
              if (((a[c] += f), a[c] != C)) break;
              (a[c--] = 0), (f = 1);
            }
          for (o = a.length; 0 === a[--o]; a.pop());
        }
        e.e > O ? (e.c = e.e = null) : e.e < d && (e.c = [(e.e = 0)]);
      }
      return e;
    }
    function D(e) {
    ...
    return (
        ...
        if (null != e) {
          ...
          if (
            ...
            e.hasOwnProperty((r = "EXPONENTIAL_AT")) &&
              ((n = e[r]) && n.pop
                ? (H(n[0], -q, 0, r), H(n[1], 0, q, r), (g = n[0]), (m = n[1]))
                : (H(n, -q, q, r), (g = -(m = n < 0 ? -n : n)))),
            e.hasOwnProperty((r = "RANGE")))
          )
            if ((n = e[r]) && n.pop)
              H(n[0], -q, -1, r), H(n[1], 1, q, r), (d = n[0]), (O = n[1]);
            else {
              if ((H(n, -q, q, r), !n))
                throw Error(U + r + " cannot be zero: " + n);
              d = -(O = n < 0 ? -n : n);
            }
          if (e.hasOwnProperty((r = "CRYPTO"))) {
            if ((n = e[r]) !== !!n)
              throw Error(U + r + " not true or false: " + n);
            if (n) {
              if (
                ...
                throw ((b = !n), Error(U + "crypto unavailable"));
              b = n;
            } else b = n;
          }
          if (
      ...
      (_.random =
        ...
        function (e) {
          var r,
            ...
            f = [],
            u = new _(w);
          if ((null == e ? (e = y) : H(e, 0, q), (i = B(e / M)), b))
            if (crypto.getRandomValues) {
              ...
              if (!crypto.randomBytes)
                throw ((b = !1), Error(U + "crypto unavailable"));
          ...
          if (!b) for (; s < i; ) (o = c()) < 9e15 && (f[s++] = o % 1e14);
          for (
            i = f[--s],
              e %= M,
              i && e && ((o = F[M - e]), (f[s] = T(i / o) * o));
            0 === f[s];
            f.pop(), s--
          );
          if (s < 0) f = [(t = 0)];
        ...
        return function (e, r, n, t, i) {
          ...
          for (
            0 <= p &&
              ...
              (E = 0),
              (e = e.replace(".", "")),
              (l = (h = new _(r)).pow(e.length - p)),
              (E = u),
              (h.c = d(X($(l.c), l.e, "0"), 10, n, m)),
              (h.e = h.c.length)),
              f = u = (a = d(e, r, n, i ? ((o = S), m) : ((o = m), S))).length;
            0 == a[--u];
            a.pop()
          );
          ...
          if (
            ...
            e = c ? X(o.charAt(1), -g, o.charAt(0)) : o.charAt(0);
          else {
            if (((a.length = s), c))
              for (--n; ++a[--s] > n; )
              ...
              if (((c = 0), (o = R(A, g, N, w)) < 0)) {
                if (
                  ...
                  for (
                    ...
                    c--, P(l, N < a ? O : A, a, i), (a = l.length), (o = 1);
                else 0 == c && (o = c = 1), (a = (l = A.slice()).length);
                if (
                  (a < w && (l = [0].concat(l)),
                  P(g, l, w, i),
                  (w = g.length),
                  ...
                  for (; R(A, g, N, w) < 1; )
                    c++, P(g, N < w ? O : A, w, i), (w = g.length);
              } else 0 === o && (c++, (g = [0]));
              (p[f++] = c),
                g[0] ? (g[w++] = E[d] || 0) : ((g = [E[d]]), (w = 1));
      ...
      (h = function (e, r, n, t) {
        var i,
          o = n ? r : r.replace(p, "");
        if (l.test(o))
          (e.s = isNaN(o) ? null : o < 0 ? -1 : 1), (e.c = e.e = null);
        else {
          if (
            !n &&
      ...
      (t.exponentiatedBy = t.pow = function (e, r) {
        ...
        if ((e = new _(e)).c && !e.isInteger())
          throw Error(U + "Exponent not an integer: " + D(e));
        if (
          (null != r && (r = new _(r)),
          (s = 14 < e.e),
          !l.c ||
            !l.c[0] ||
            (1 == l.c[0] && !l.e && 1 == l.c.length) ||
            !e.c ||
            !e.c[0])
        )
          return (
            (c = new _(Math.pow(+D(l), s ? 2 - V(e) : +D(e)))), r ? c.mod(r) : c
          );
        if (((f = e.s < 0), r)) {
          if (r.c ? !r.c[0] : !r.s) return new _(NaN);
          (t = !f && l.isInteger() && r.isInteger()) && (l = l.mod(r));
        } else {
          if (
            9 < e.e &&
            (0 < l.e ||
              l.e < -1 ||
              (0 == l.e
                ? 1 < l.c[0] || (s && 24e7 <= l.c[1])
                : l.c[0] < 8e13 || (s && l.c[0] <= 9999975e7)))
          )
            return (
              (o = l.s < 0 && V(e) ? -0 : 0),
              -1 < l.e && (o = 1 / o),
        ...
        for (
          ...
          if (u) {
            ...
            o ? c.c.length > o && (c.c.length = o) : t && (c = c.mod(r));
          }
          if (i) {
            if (0 === (i = T(i / 2))) break;
            u = i % 2;
          ...
          (l = l.times(l)),
            o ? l.c && l.c.length > o && (l.c.length = o) : t && (l = l.mod(r));
        }
        return t
          ? c
          : (f && (c = w.div(c)), r ? c.mod(r) : o ? x(c, E, N, void 0) : c);
      }),
      ...
      (t.minus = function (e, r) {
        ...
        var u = s.e / M,
          ...
          a = e.c;
        if (!u || !c) {
          if (!l || !a) return l ? ((e.s = -r), e) : new _(a ? s : NaN);
          if (!l[0] || !a[0])
            return a[0] ? ((e.s = -r), e) : new _(l[0] ? s : 3 == N ? -0 : 0);
        }
        if (((u = j(u)), (c = j(c)), (l = l.slice()), (f = u - c))) {
          for (
            (i = (o = f < 0) ? ((f = -f), l) : ((c = u), a)).reverse(), r = f;
            r--;
            i.push(0)
          );
          i.reverse();
          ...
          for (
            t = (o = (f = l.length) < (r = a.length)) ? f : r, f = r = 0;
            r < t;
            r++
          )
            if (l[r] != a[r]) {
        ...
        if (
          (o && ((i = l), (l = a), (a = i), (e.s = -e.s)),
          0 < (r = (t = a.length) - (n = l.length)))
        )
          for (; r--; l[n++] = 0);
        for (r = C - 1; f < t; ) {
          if (l[--t] < a[t]) {
      ...
      (t.multipliedBy = t.times = function (e, r) {
        ...
        if (!(v && y && v[0] && y[0]))
          return (
            !d.s || !e.s || (v && !v[0] && !y) || (y && !y[0] && !v)
              ? (e.c = e.e = e.s = null)
              : ((e.s *= d.s),
                v && y ? ((e.c = [0]), (e.e = 0)) : (e.c = e.e = null)),
            e
          );
        for (
          t = j(d.e / M) + j(e.e / M),
            e.s *= d.s,
            (u = v.length) < (a = y.length) &&
              ((g = v), (v = y), (y = g), (i = u), (u = a), (a = i)),
            i = u + a,
            g = [];
          i--;
          g.push(0)
      ...
      (t.precision = t.sd = function (e, r) {
        ...
        if (null != e && e !== !!e)
          return (
            H(e, 1, q), null == r ? (r = N) : H(r, 0, 8), x(new _(this), e, r)
          );
        if (!(n = this.c)) return null;
            ...
            if (
              ...
              if (
                ...
                (+r && (+r.slice(1) || "5" != r.charAt(0))) ||
                  (x(n, n.e + y + 2, 1), (e = !n.times(n).eq(o)));
                break;
              }
      ...
      (t.toFormat = function (e, r, n) {
        ...
        if (((t = this.toFixed(e, r)), this.c)) {
          ...
          if ((f && ((i = s), (s = f), (p -= f = i)), 0 < s && 0 < p)) {
            for (i = p % s || s, c = h.substr(0, i); i < p; i += s)
              c += u + h.substr(i, s);
            0 < f && (c += u + h.slice(i)), a && (c = "-" + c);
          }
          t = l
            ? c +
              (n.decimalSeparator || "") +
      ...
      (t.toFraction = function (e) {
        ...
        for (
          r = new _(w),
            ...
            t = u = new _(w),
            h = $(g),
            o = r.e = h.length - p.e - 1,
            r.c[0] = F[(s = o % M) < 0 ? M + s : s],
            e = !e || 0 < f.comparedTo(r) ? (0 < o ? r : c) : f,
            s = O,
            O = 1 / 0,
            f = new _(h),
            u.c[0] = 0;
          (l = v(f, r, 0, 1)), 1 != (i = n.plus(l.times(t))).comparedTo(e);

        )
          (n = t),
            (t = i),
            (c = u.plus(l.times((i = c)))),
            (u = i),
        ...
        return (
          ...
          (a =
            v(c, t, (o *= 2), N)
              .minus(p)
              .abs()
              .comparedTo(v(u, n, o, N).minus(p).abs()) < 1
              ? [c, t]
              : [u, n]),
          (O = s),
          a
